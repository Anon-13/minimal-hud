return {
	...
	framework = "qb", -- none, esx, qb, ox, custom. If you wanna enable the hunger/thirst/stress stats you need to use a framework, or you can edit the source code to tailor your  own custom framework
}
